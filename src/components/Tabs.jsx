...
const tabData = {
  about: (
    <p>
      ...
      <br />
      <br />
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi quia cum
      ipsam illum optio ab cumque blanditiis accusantium illo, vel obcaecati
      quae dolorem porro rem sapiente numquam maxime soluta beatae expedita
      inventore recusandae omnis corporis. Perferendis culpa dolor accusantium
      obcaecati cum tempore consequuntur porro praesentium. Lorem ipsum, dolor
      sit amet consectetur adipisicing elit. Praesentium assumenda harum, odio
      neque numquam commodi quisquam quae itaque, molestiae veritatis dolore
      officiis nobis libero perferendis ratione? Unde mollitia suscipit facere
      vero nemo quia, ipsam hic!
    </p>
  ),
  experiences: (
    <p>
      I have over 5 years of sales experience in the tech industry. Over the
      past few years, I’ve helped companies improve their workflows and have
      contributed to major projects in B2B sales, with a focus on providing
      long-term value and support to clients.
    </p>
  ),
  recommended: (
    <p>
      I highly recommend Dave for his thorough expertise in B2B sales and
      customer relationship management. He has been a huge asset to our company,
      providing valuable insight and exceptional results.
    </p>
  ),
};
...
const Tabs = () => {
  ...
  return (
    <div className="tab-container p-4 bg-[#363C43] flex text-[#bfc2c5] rounded-2xl max-w-[720px] min-h-[320px] shadow-md">
      <div className="mr-4">
        <svg
          width="24"
          height="160"
      ...
      <div>
        {/* Tabs Section */}
        <div className="flex flex-col lg:flex-row w-full justify-around mb-4 px-2 py-2 bg-[#171717] rounded-[23px] items-center">
          <button
            className={`px-8 w-full py-3 text-sm font-semibold rounded-[15px] ${
              activeTab === "about"
        ...
        {/* Content Section */}
        <div className="p-4 rounded-xl text-sm leading-6 max-h-[180px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-transparent scrollbar-thumb-rounded-full">
          {tabData[activeTab]}
        </div>
      </div>
    </div>
